...
class SphereTest {
    ...
    public void FindIntersections() {
        ...
        assertEquals(
                List.of(p2),// we make a list of 1 point, because we expect only 1 intersection
        ...
        // we don't expect any intersections
        assertNull(
                sphere.findIntersections(
        ...
        // There are no intersections because it doesn't count the intersection with the ray head
        assertNull(
        ...
        assertEquals(2, result.size(), "Wrong number of points"); // checks if there are 2 intersections
